<template>
  <header class="header px-10 relative">
    <div class="row">
      <div class="box flex justify-between items-center w-full h-screen">
        <div class="w-[60%] h-screen flex items-center">
          <div class="w-1/3 h-screen bg-brand absolute left-0 top-0 -z-10"></div>
          <img src="@/assets/images/pro_header.jpg" class="w-full h-96 object-cover" alt="">
        </div>
        <div class="w-[38%] text-left flex-col gap-4 flex">
          <h2 class="text-2xl">Beautiful wood siding</h2>
          <h1 class="text-7xl">Enhance your architecture</h1>
          <p>
